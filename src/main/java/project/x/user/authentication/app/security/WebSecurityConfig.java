package project.x.user.authentication.app.security;

import project.x.user.authentication.app.security.jwt.AuthEntryPointJwt; // Import for unauthorized access handler
import project.x.user.authentication.app.security.jwt.AuthTokenFilter; // Import for JWT token filter
import project.x.user.authentication.app.security.services.UserDetailsServiceImpl; // Import for user details service implementation
