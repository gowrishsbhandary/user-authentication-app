package project.x.user.authentication.app.security.jwt;
...
import project.x.user.authentication.app.security.services.UserDetailsServiceImpl; // Import custom user details service
