package project.x.user.authentication.app.security.services;

import project.x.user.authentication.app.models.User; // Import User model
import project.x.user.authentication.app.repository.UserRepository; // Import UserRepository for user database operations
